...
},{}],"src/views/core.ts":[function(require,module,exports) {
"use strict";
...
class CoreField {
  ...
  get value() {
    var _a;
    return (_a = this.data.text) !== null && _a !== void 0 ? _a : '';
  }
}
exports.default = CoreField;
},{}],"src/views/login.text-field.template.ts":[function(require,module,exports) {
"use strict";
...
},{}],"src/views/login.text-field.ts":[function(require,module,exports) {
"use strict";
...
const login_text_field_template_1 = __importDefault(require("./login.text-field.template"));
class TextField extends core_1.default {
  constructor(container, data) {
    ...
    (0, utils_1.nextTick)(__classPrivateFieldGet(this, _TextField_attachEventHandler, "f"));
  }
  get isValid() {
...
},{}],"../../../.nvm/versions/node/v20.8.1/lib/node_modules/parcel-bundler/node_modules/base64-js/index.js":[function(require,module,exports) {
'use strict'
...
},{}],"../../../.nvm/versions/node/v20.8.1/lib/node_modules/parcel-bundler/node_modules/ieee754/index.js":[function(require,module,exports) {
...
},{}],"../../../.nvm/versions/node/v20.8.1/lib/node_modules/parcel-bundler/node_modules/isarray/index.js":[function(require,module,exports) {
...
},{}],"../../../.nvm/versions/node/v20.8.1/lib/node_modules/parcel-bundler/node_modules/buffer/index.js":[function(require,module,exports) {
...
},{"base64-js":"../../../.nvm/versions/node/v20.8.1/lib/node_modules/parcel-bundler/node_modules/base64-js/index.js","ieee754":"../../../.nvm/versions/node/v20.8.1/lib/node_modules/parcel-bundler/node_modules/ieee754/index.js","isarray":"../../../.nvm/versions/node/v20.8.1/lib/node_modules/parcel-bundler/node_modules/isarray/index.js","buffer":"../../../.nvm/versions/node/v20.8.1/lib/node_modules/parcel-bundler/node_modules/buffer/index.js"}],"node_modules/axios/lib/helpers/toFormData.js":[function(require,module,exports) {
...
const login_text_field_1 = __importDefault(require("../views/login.text-field"));
const login_template_1 = __importDefault(require("./login.template"));
...
class Login {
  constructor(container, data) {
    ...
    _Login_initialize.set(this, () => {
      ...
      const passwordField = new login_text_field_1.default('#login-fields', {
        id: 'password',
        label: '비밀번호',
        type: 'password',
...
exports.default = TextField;
},{"../constant":"src/constant.ts","../utils":"src/utils/index.ts","./text-field.template":"src/views/text-field.template.ts"}],"src/views/password-field.template.ts":[function(require,module,exports) {
"use strict";
...
},{"../constant":"src/constant.ts","../utils":"src/utils/index.ts","./password-field.template":"src/views/password-field.template.ts"}],"src/views/index.ts":[function(require,module,exports) {
"use strict";
...
exports.LoginTextField = exports.PasswordField = exports.TextField = exports.AddressField = void 0;
...
var login_text_field_1 = require("./login.text-field");
Object.defineProperty(exports, "LoginTextField", {
  enumerable: true,
  get: function () {
    return __importDefault(login_text_field_1).default;
  }
});
},{"./address-field":"src/views/address-field.ts","./text-field":"src/views/text-field.ts","./password-field":"src/views/password-field.ts","./login.text-field":"src/views/login.text-field.ts"}],"src/page/signup.ts":[function(require,module,exports) {
"use strict";
...
const signup_template_1 = __importDefault(require("./signup.template"));
const constant_1 = require("../constant");
const views_1 = require("../views");
class Signup {
  constructor(container, data = {}) {
    this.template = signup_template_1.default;
    this.active = false;
    this.initialize = () => {
...
},{"./signup.template":"src/page/signup.template.ts","../constant":"src/constant.ts","../views":"src/views/index.ts"}],"src/store.ts":[function(require,module,exports) {
"use strict";
...
var _Store_token, _Store_userProfile, _Store_userPosts;
Object.defineProperty(exports, "__esModule", {
  value: true
});
class Store {
  constructor() {
    _Store_token.set(this, void 0);
    _Store_userProfile.set(this, void 0);
    _Store_userPosts.set(this, void 0);
    __classPrivateFieldSet(this, _Store_token, '', "f");
    __classPrivateFieldSet(this, _Store_userProfile, null, "f");
    __classPrivateFieldSet(this, _Store_userPosts, null, "f");
  }
  set userProfile(profile) {
    __classPrivateFieldSet(this, _Store_userProfile, profile, "f");
  }
  get userProfile() {
    return __classPrivateFieldGet(this, _Store_userProfile, "f");
  }
  set userPosts(posts) {
    __classPrivateFieldSet(this, _Store_userPosts, posts, "f");
  }
  get userPosts() {
    return __classPrivateFieldGet(this, _Store_userPosts, "f");
  }
  set token(token) {
    __classPrivateFieldSet(this, _Store_token, token, "f");
  }
  get token() {
    return __classPrivateFieldGet(this, _Store_token, "f");
  }
}
_Store_token = new WeakMap(), _Store_userProfile = new WeakMap(), _Store_userPosts = new WeakMap();
...
function router() {
  ...
  switch (path) {
    case '':
    case '#/login':
      const login = new login_1.default('#root', {
        store,
    ...
    case '#/post':
      break;
    case '#/signup':
      const signup = new signup_1.default('#root', {
